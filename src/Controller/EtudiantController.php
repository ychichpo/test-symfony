...
class EtudiantController extends AbstractController
{
    ...
    #[Route('/age', name: 'app_etudiant_age_20', methods: ['GET'])]
    public function etudiantsAge20(EtudiantRepository $etudiantRepository): Response
    {

        $etudiants = $etudiantRepository->findBy(['age' => 20]);
   ...
   #[Route('/age/{nb}', name: 'app_etudiant_age', methods: ['GET'])]
    public function age(EtudiantRepository $etudiantRepository,int $nb): Response
    {

        return $this->render('etudiant/indexAge.html.twig', [
            'etudiants' => $etudiantRepository->findAll(),
            'age'=>$nb,
        ]);
